    ...
    <div className={style.container} data-aos='slide-down'>
        ...
        <div className={style.payment} onClick={()=> setOpen(!open)}>
          ...
          {open ?<div className={style.btn}>
            <button  onClick={(e)=> setText(e.target.textContent)}>Individual</button>
            <button onClick={(e)=> setText(e.target.textContent)}>Multiple (All)</button>
           </div>:""}
        </div>
        ...
        <div className={style.amount}>
            ...
            <button><BsUpload/>&nbsp; Upload Multiple Agent File</button>
        </div>
   </div>
